...
/**
 * Basic 页面。
 * 演示默认 window/document 根滚动、replaceHash，
...
export function Basic() {
	...
	// replaceHash 由目录组件统一处理，避免重复更新 URL。
			...
			<div className="mx-auto max-w-2xl">
				...
				<div className="mb-8 rounded-md border border-border bg-card p-4 text-sm">
					...
					<div className="grid grid-cols-2 gap-2 text-muted sm:grid-cols-4">
						...
						<div>
							<span className="block text-xs">replaceHash</span>
							<span className="font-mono text-fg">true</span>
						</div>
					</div>
				</div>
