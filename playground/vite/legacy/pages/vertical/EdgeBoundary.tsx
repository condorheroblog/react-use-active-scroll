...
export function EdgeBoundary() {
	...
	const [options, setOptions] = useQueryStates({
		ef: parseAsInteger.withDefault(-280),
		el: parseAsInteger.withDefault(300),
		ots: parseAsInteger.withDefault(100),
		ote: parseAsInteger.withDefault(500),
	})
	...
	return (
		...
		<PageShell
			tocData={{
				...
				offset: { toStart: options.ots, toEnd: options.ote },
			}}
